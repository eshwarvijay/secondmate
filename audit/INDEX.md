...
- 2026-09-10 — harden-checker-invariant: fix the documented checker-pane recipe's herdr pane run quoting bug + add a standing SessionSt... (`audit/flow/2026-09-10--harden-checker-invariant-fix-the-documented-checker-pane-recipe-s-herdr-pane-run.md`)
...
- 2026-09-11 — fix-scope-guard-marker-doc: resolve the /scope-guard-marker doc/registration mismatch (fan-out live validation, sibling... (`audit/flow/2026-09-11--fix-scope-guard-marker-doc-resolve-the-scope-guard-marker-doc-registration-misma.md`)
...
- 2026-09-24 — doctor-pi-model-overrides: bin/doctor.sh detects and heals AWS Bedrock model-metadata overrides (kimi-k3, deepseek-r1) i... (`audit/flow/2026-09-24--doctor-pi-model-overrides-bin-doctor-sh-detects-and-heals-aws-bedrock-model-meta.md`)
...
- 2026-09-10 — harden-checker-invariant: fix the documented checker-pane recipe's herdr pane run quoting bug + add a standing SessionSt... (`audit/decision/2026-09-10--harden-checker-invariant-fix-the-documented-checker-pane-recipe-s-herdr-pane-run.md`)
...
- 2026-09-11 — fix-scope-guard-marker-doc: resolve the /scope-guard-marker doc/registration mismatch (fan-out live validation, sibling... (`audit/decision/2026-09-11--fix-scope-guard-marker-doc-resolve-the-scope-guard-marker-doc-registration-misma.md`)
